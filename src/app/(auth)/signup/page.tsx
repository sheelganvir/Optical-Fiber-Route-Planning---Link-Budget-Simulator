      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 space-y-6 shadow-2xl">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">
            Register for persistent fiber link budget calculations & GIS route storage
          </p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4 text-xs">
          ...
          <div>
            <label className="block text-slate-300 font-semibold mb-1">Engineering Email</label>
            <div className="relative">
          ...
          >
            <span>{loading ? "Registering Account..." : "Create Account & Enter Console"}</span>
